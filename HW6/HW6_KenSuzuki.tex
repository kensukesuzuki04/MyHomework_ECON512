...
\begin{align}
\pi(k_t,k_{t+1},p_t) = p \cdot (k_{t+1}-k_t) - 0.2 \cdot (k_{t+1}-k_t)^{1.5}
\end{align}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%
\section*{Problem 5: Expected stock}
...
\begin{center}
\caption{Problem 5}
\includegraphics[width=0.7\textwidth]{prob5.png}
\end{center}
\end{figure}
...
I know use 5 grid points and generate the grid and transition probability for $p_t$.
...
\begin{center}
\caption{Problem 6-5}
\includegraphics[width=0.7\textwidth]{prob6_3.png}
\end{center}
\end{figure}
